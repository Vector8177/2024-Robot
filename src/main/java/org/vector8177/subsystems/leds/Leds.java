...
package org.vector8177.subsystems.leds;

import org.vector8177.util.VirtualSubsystem;
...
public class Leds extends VirtualSubsystem {
  ...
  // Constants
  private static final boolean rainbowLeds = true;
  ...
  public synchronized void periodic() {
    ...
    // // Select LED mode
    // solid(Color.kOrange); // Default to off
    // if (estopped) {
    //   solid(Color.kRed);
